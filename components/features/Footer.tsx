  ...
  return (
    <footer className='flex flex-col text-black-100 mt-5 border-t border-gray-300 items-center'>
        <div className='flex max-md:flex-col flex-wrap justify-between items-center gap-10 sm:px-16 lg:px-10 px-6 py-10 w-full lg:max-w-[1024px] xl:max-w-[10280px] laptop:max-w-[1440px]'>
            <div className='w-full flex flex-col sm:flex-row sm:flex-wrap justify-between items-cneter gap-6 border-b border-gray-200 pb-8'>
                <div className=' flex flex-col justify-start items-start gap-6'>
                    <Image src="/logo.svg" alt="logo" width={118} height={18} className='object-contain'/>
                    <p className='text-base text-gray-700'>Carhub 2024<br/> All rights reserved </p>
                </div>
                <div className='flex w-full sm:w-1/2 flex-col justify-center items-start gap-4'>
        ...
        <div className='gap-4 flex flex-col justify-between items-center flex-wrap mt-5 lg:mt-10 border-t border-gray-100 sm:px-16 px-6 py-10'>
